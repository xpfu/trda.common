package com.trda.core.freemaker.utils;
...
public class FreemarkerTagUtil {
	 ...
	 */
	public static Map<String, TemplateModel> convertToTemplateModel(Environment env, Map<String, TemplateModel> maps)
			throws TemplateException {
